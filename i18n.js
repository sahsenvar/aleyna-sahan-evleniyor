...
(function () {
  ...
  const I18N = {
    tr: {
      ...
      "mem.delete": "Kaldır",
      "mem.deleteConfirm": "Bu öğeyi albümden kaldırmak istiyor musunuz?",
      "mem.deleteError": "Kaldırılamadı, lütfen tekrar deneyin.",
      "mem.close": "Kapat",
    ...
    fr: {
      ...
      "mem.deleteConfirm": "Supprimer cet élément de l'album ?",
      "mem.deleteError": "Échec de la suppression, veuillez réessayer.",
      "mem.close": "Fermer",
    ...
    en: {
      ...
      "mem.delete": "Remove",
      "mem.deleteConfirm": "Remove this item from the album?",
      "mem.deleteError": "Couldn't remove, please try again.",
      "mem.close": "Close",
